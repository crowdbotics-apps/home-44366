"""
Django settings for home_44366 project.
...
WSGI_APPLICATION = 'home_44366.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "home_44366 API",
    "DESCRIPTION": "API documentation for home_44366 App",
    "VERSION": "v1",
}
